...
* **Basic app price** - dari $60.000 hingga $120.000 per platform (misalnya McDonald's Loyalty)

* **Biaya aplikasi kompleks, kustom (multi-fitur)** -  starts from $230,000+ (e.g.Uber, Instagram) 

waktu proses pengembangan aplikasi juga bervariasi dari 2-3 bulan untuk aplikasi kecil, 3-6 bulan untuk aplikasi dengan dengan fitur dasar, dan 9 + bulan untuk produk yang kompleks, yang dianggap sebagai proyek yang sedang berlangsung.
...
* Rata-rata proyek pengembangan aplikasi minimum adalah antara $ 5.000 hingga $ 10.000. Biaya khas untuk membuat aplikasi cenderung jauh lebih tinggi (Survei Kopling, 2017)

* Enterprise mobile app development cost is an average of $140,000 (VDC Research, 2017)

* Kalkulator biaya aplikasi yang tersedia menyatakan kisaran harga dari $ 267.000 hingga $ 360.000 untuk aplikasi seluler multi-fitur yang kompleks
...
* Infrastruktur back-end dan API yang terhubung
* Kompleksitas desain UX/UI
* Dimasukkannya elemen visual bermerek tambahan
* Pendekatan pengembangan (asli, web seluler, hibrid, dll)
